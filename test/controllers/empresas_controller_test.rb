...
class EmpresasControllerTest < ActionController::TestCase
  ...
  test "should create empresa" do
    assert_difference('Empresa.count') do
      post :create, empresa: { comunidad: @empresa.comunidad, direccion: @empresa.direccion, municipio: @empresa.municipio, nombre: @empresa.nombre }
    end
  ...
  test "should update empresa" do
    patch :update, id: @empresa, empresa: { comunidad: @empresa.comunidad, direccion: @empresa.direccion, municipio: @empresa.municipio, nombre: @empresa.nombre }
    assert_redirected_to empresa_path(assigns(:empresa))
  end

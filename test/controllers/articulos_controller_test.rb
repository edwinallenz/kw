...
class ArticulosControllerTest < ActionController::TestCase
  ...
  test "should create articulo" do
    assert_difference('Articulo.count') do
      post :create, articulo: { codigo: @articulo.codigo, nombre: @articulo.nombre, tecnica_id: @articulo.tecnica_id }
    end
  ...
  test "should update articulo" do
    patch :update, id: @articulo, articulo: { codigo: @articulo.codigo, nombre: @articulo.nombre, tecnica_id: @articulo.tecnica_id }
    assert_redirected_to articulo_path(assigns(:articulo))
  end
